        ...
        <div className="flex space-x-4 mb-8 overflow-x-auto pb-2">
          {['experience', 'projects', 'skills', 'resume'].map((tab) => (
            <button
              ...
              className={`px-6 py-2 text-[10px] tracking-widest uppercase border whitespace-nowrap transition-all ${
                activeTab === tab ? 'bg-primary text-on-primary border-primary' : 'border-outline/20 opacity-50 hover:opacity-100'
              }`}
            >
              {tab}.DAT
            </button>
